...
/********************* Si vous sélectionnez un groupe, la fonction affichera les équipes et leurs drapeaux qui correspondent au groupe********************************* */
...
function selectedGroup(t) {
  ...
  viderLesInfo();
  for (let i = 0; i < 4; i++) {
    document.getElementById('team-'+(i + 1)).value=filteredGroup[i].name_en

    // les images des drapeaux télécharger par un site web
    document.getElementById('flag-team-'+(i + 1)).src='https://flagcdn.com/h80/'+filteredGroup[i].iso2.toLocaleLowerCase()+'.png'
  
  }
}

/**************************** une fonction qui scrolle la page si en clique au groupe ************************* */
...
/*******************une fonction qui vide les données  ********************* */
...
/************************ si on clique sur une équipe, affiche l'image des joueurs le tableau ********************** */

function selectedTeam(t) {
  var teaminfo = document.getElementById("team-info");
  teaminfo.classList.remove("hide");
  volet_4.classList.remove("hide");
  volet4.classList.remove("hide");
  document.getElementById("player-info").classList.add("hide");
...
/*********************une fonction affiche la fiche technique du joueur sélectionner ****************************** */
...
var volet_4 = document.getElementById("volet-4");
var ajouterzone = document.getElementById("Addzone");
var editerzone = document.getElementById("editzone");

 // cacher les zones "addzone" et "editzone", puis affiche le tableau
...
/************** cacher la zone "editzone" et tableau , puis affiche "addzone"********************* */
function Ajouter() {
...
/***********cacher la zone "editzone" et tableau , puis affiche "addzone" et affiche des données du joueur *********** */
function Editer(t) {
  ajouterzone.classList.add("hide");
...
/**************ajouter les données du nouveau joueur ********************** */
...
/*******************modifier des données du joueurs *********************** */
